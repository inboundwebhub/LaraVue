            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="myTable" class="table table-bordered table-striped table-responsive display" style="display:inline-table; width: 100%" v-if="tasks.length > 0">
                            <thead>
                            <tr>
                                <th>
                                    No.
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="operator" id="operator" placeholder="Task operator" class="form-control"
                                   v-model="task.operator">
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Task operator" class="form-control"
                                   v-model="update_task.operator">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    export default {
        ...
        methods: {
            ...
            .catch(error => {
                ...
                if (error.response.data.errors.operator) {
                    this.errors.push(error.response.data.errors.operator[0]);
                }
            });
            },
            reset()
            ...
            updateTask()
            {
                axios.patch('/task/' + this.update_task.id, {
                    ...
                    operator: this.update_task.operator,
                })
                    .then(response => {
